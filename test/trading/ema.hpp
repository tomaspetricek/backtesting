...
BOOST_AUTO_TEST_SUITE(ema_test)
    ...
    {
        ma_usage_test<5, 1, ema>({1, 2, 3, 7, 9}, {1, 2, 3, 7, 9}, 0.0001);
        ma_usage_test<5, 1, ema>({-1, 2, -3, 7, -9}, {-1, 2, -3, 7, -9}, 0.0001);
        ma_usage_test<5, 2, ema>({1, 2, 3, 7, 9}, {1.5, 2.5, 5.5, 7.83333333}, 0.0001);
        ma_usage_test<5, 2, ema>({-1, 2, -3, 7, -9}, {0.5, -1.83333333, 4.05555556, -4.64814815}, 0.0001);
        ma_usage_test<5, 3, ema>({1, 2, 3, 7, 9}, {2.0, 4.5, 6.75}, 0.0001);
        ma_usage_test<5, 3, ema>({-1, 2, -3, 7, -9}, {-0.66666667, 3.16666667, -2.91666667}, 0.0001);
    }
