...
namespace trading {
    ...
    public:
        action operator()(const price_t& curr)
        {
            ...
            if (static_cast<ConcreteStrategy*>(this)->should_buy()) {
                return action::buy;
            }
            else if (static_cast<ConcreteStrategy*>(this)->should_sell()) {
                return action::sell;
            }
            else if (static_cast<ConcreteStrategy*>(this)->should_sell_all()) {
