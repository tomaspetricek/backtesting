...
#ifndef EMASTRATEGY_PERCENT_SHORT_STATS_HPP
#define EMASTRATEGY_PERCENT_SHORT_STATS_HPP
...
namespace trading::percent {
    class short_stats : public trading::stats {
    public:
        explicit short_stats(const std::vector<trade>& closed)
...
#endif //EMASTRATEGY_SHORT_STATS_HPP
