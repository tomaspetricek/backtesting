...
Třída \texttt{manager} spojuje funkčnost strategie a manažera.
Implementuje jedinou metodu volání, která rozhoduje, kdy obchodovat.
...
\subsection{Pozice}
Nejprve byla testována výchozí inicializace pro kontrolu, že jsou všechny atributy správně inicializovány.
Pozice by měla být otevřena předáním otevírací objednávky, nicméně  může být někdy nutné použít výchozí konstruktor.
Testována byla i běžná inicializace.
Hlavním provedeným testem byl test použití, během kterého byla pozice otevřena, navýšena a uzavřena.
Během testu jsou počítány očekávaná celková investovaná částka a očekávaná velikost pozice pro porovnání výsledků volání metod a pro kontrolu stavu atributů pozice.
