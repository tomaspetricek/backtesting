...
Při testování jsou data rozdělena do více segmentů, které jsou dále rozděleny na 2 části, vzorky použité pro optimalizaci a vzorky použité pro validaci.
Po dokončení testu jsou výsledky prezentovány ve formě zprávy \cite{multicharts}.
...
\subsection{Shromažďování výsledků}
...
\chapter{Čtení a zápis do souborů}
