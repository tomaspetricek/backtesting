...
Manažer a strategie jsou dány dohromady pomocí třídy \texttt{bazooka::trader}.
Používá vícenásobnou veřejnou dědičnost, takže veřejní členové těchto 2 tříd jsou přístupní přímo.
Poskytuje metodu \texttt{trade} \ref{lst:trade}, která používá metody obou tříd.
Strategie dělá rozhodnutí, na která pak manažer reaguje.
...
Mezi třídní atributy patří: aktivní pozice, poslední uzavřená pozice, peněženka a výši poplatků spojených s splněním objednávek.

Peněženka je implementována třídou \texttt{wallet} a slouží ke správě zůstatku zákaznického účtu.
Zůstatek lze snížit výběrem nebo navýšit vkladem.
...
Po otevření lze pozici uzavřít vcelku voláním metody \texttt{fill\_close\_all\_order}, nikoli po částech.
...
Lze ji otevřít vytvořením instance třídy, zvýšit voláním metody \texttt{increase} nebo ji uzavřít pomocí metody \texttt{close}.
