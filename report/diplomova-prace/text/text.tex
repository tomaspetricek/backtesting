...
Pro daný typ je vytvořena specializace struktury \texttt{adl\_serializer}, která mohou být implementovány metody \texttt{from\_json} pro deserializaci a \texttt{to\_json} pro serializaci.
