...
Byly implementovány 2 indikátory založené na klouzavém průměru \texttt{sma} a \texttt{ema}.
...
\begin{figure}[!htbp]
\centerline{\includegraphics[scale=0.55]{img/genetic-algorithm-white-box-progress.png}}
...
\begin{figure}[!htbp]
\centerline{\includegraphics[scale=0.55]{img/simulated-annealing-white-box-progress.png}}
