...
template<class Result, class... Observer>
std::vector<state<State>> operator()(const std::vector<State>& init_genes,
    Result& result,
    Constraints<state_type> auto&& constraints,
    ObjectiveFunction<State> auto&& fitness,
    PopulationSizer auto&& size,
    Selection<state_type> auto&& select,
    Matchmaker<state_type> auto&& match,
    Crossover<State> auto&& crossover,
    Mutation<State> auto&& mutate,
    Replacement<state_type> auto&& replace,
    TerminationCriteria<optimizer<State>> auto&& terminate,
    Observer& ... observers)
{
