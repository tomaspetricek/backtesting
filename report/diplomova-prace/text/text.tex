...
Nejběžněji dostupná jsou data ve formátu OHLCV, což jsou OHLC a objem (volume), což je množství obchodů uskutečněných v daném časovém intervalu.
...
Používá se především pro vizualizaci dat a technickou analýzu, k čemuž nabízí nástroje pro kreslení do grafů.
Výsledné nápady lze uložit a sdílet s ostatními uživateli.
Grafy lze vizualizovat a organizovat různými způsoby.
Nabízí použití mnoha technických indikátorů \cite{tradingview}.
