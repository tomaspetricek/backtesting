...
Bylo provedeno několik sad testů s cílem spolehlivě najít nejlepší konfigurace pro všechny měny v co nejkratším čase.
Počet rodičů a potomků byl stanoven na 2.
...
\begin{table}[!htbp]
\centering
\caption[Nastavení použité pro optimalizaci]{~Nastavení použité pro optimalizaci}
...
\begin{table}[!htbp]
\centering
\caption[Výsledky white-box testování]{~Výsledky white-box testování}
...
V případě SOL a XRP byly nalezené stavy o méně než \(-1\) \% horší než nejlepší a pro ETH o \mbox{\(-4,4\) \%}.
Celkově byly nalezeny velmi dobré konfigurace v přiměřeně krátkém čase.

\begin{table}[!htbp]
\centering
\caption[Výsledky black-box testování]{~Výsledky black-box testování}
